...
<br>&#x2705; Feb 20, 2026: The [multimodal datasets](https://huggingface.co/datasets/ChenLiu1996/ImmunoStruct) and [model weights](https://huggingface.co/ChenLiu1996/ImmunoStruct) are now open-sourced on huggingface. See [instructions](https://github.com/KrishnaswamyLab/ImmunoStruct?tab=readme-ov-file#data-preparation).
